function ex1() {
  ...
  function ex2() {
    ...
    alert("A multiplicação dos número resulta-se em: " + result2)
  }
  ...
  function ex3() {
    ...
    if (num2 == 0) {
      ...
      alert("A divisão resulta-se em: " + result3)
    }
  }
  ...
  function ex4() {
    ...
    alert("A média ponderada das notas é: " + result4)
  }
  ...
  function ex5() {
    ...
    alert("O novo preço é R$" + result5)
  }
  ...
  function ex6() {
    ...
    alert(
      "A comissão do funcionário é R$ " +
        comissao +
        " ,logo seu salário final é R$ " +
        result6
    )
  }
  ...
  function ex7() {
    ...
    alert(
      "Seu peso caso engorde 15% é " +
        resultmore7 +
        " kg, e seu peso caso emagreça 20% é " +
        resultless7 +
        " kg."
    )
  }
  ...
  function ex8() {
    ...
    alert("O seu peso em gramas é: " + result8 + " g.")
  }
